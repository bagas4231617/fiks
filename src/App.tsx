  ...
  const projects = [
    {
      ...
      image: "https://picsum.photos/seed/network-topology/1200/800" // Ganti dengan: "/assets/gambar-proyek.jpg"
    },
    {
      ...
      image: "https://picsum.photos/seed/linux-server/1200/800" // Ganti dengan: "/assets/gambar-proyek.jpg"
    },
    {
      ...
      image: "https://picsum.photos/seed/it-maintenance/1200/800" // Ganti dengan: "/assets/gambar-proyek.jpg"
    }
  ];
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="mobile-nav-links">
              <a href="#profil" onClick={() => setIsMobileMenuOpen(false)}>Profil</a>
              <a href="#sertifikat" onClick={() => setIsMobileMenuOpen(false)}>Sertifikat</a>
              <a href="#proyek" onClick={() => setIsMobileMenuOpen(false)}>Proyek</a>
              ...
              <button className="theme-toggle" onClick={() => { toggleTheme(); setIsMobileMenuOpen(false); }} style={{ marginTop: '1rem' }}>
                {theme === 'dark' ? <Sun size={24} /> : <Moon size={24} />} Tema {theme === 'dark' ? 'Terang' : 'Gelap'}
              </button>
            </div>
          </motion.div>
        )}
